...
namespace AP.IdentityServer.Extensions
{
    public static class CryptorEngine
    {
        public const string PUBLICKEY = "D45csl02dcn30Dkf";
        ...
        public static string EncryptForHTML(string plainText)
        {
            ...
            encrypt = encrypt.Replace("=", "a_b_c");
            encrypt = encrypt.Replace("+", "c_b_a");
            return encrypt;
        }
        ...
        public static string EncryptByKey(string plainText, string key)
        {
            ...
            // Return encrypted string.
            return cipherText = cipherText.Replace("/", "$$"); ;
        }
        ...
        {
            cipherText = cipherText.Replace("a_b_c", "=");
            cipherText = cipherText.Replace("c_b_a", "+");
        ...
        {
            return GetMd5X2(password);
        }

        private static string GetMd5X2(string str)
        {
